...
root = tk.Tk()
root.title("Panel de Control - Aeropuertos (Versión 1)")
...
tk.Label(frame_inputs, text="Código:", bg=color_fondo, fg="black").grid(row=0, column=0, padx=5, pady=10)
...
tk.Button(frame_inputs, text="Añadir a la Lista", command=agregar_nuevo, bg=color_anadir, fg="black",  font=("Helvetica", 9, "bold")).grid(row=1, column=1, columnspan=2, padx=10, pady=10)
tk.Button(frame_inputs, text="Borrar por Código", command=eliminar_existente, bg=color_borrar, fg="black", font=("Helvetica", 9, "bold")).grid(row=1, column=3, columnspan=2, padx=10, pady=10)
...
tk.Button(frame_visual, text="Ver Gráfica de Barras", command=mostrar_grafica, bg=color_visual, fg="black", width=22, font=("Helvetica", 10, "bold")).grid(row=0, column=0, padx=10, pady=8)
